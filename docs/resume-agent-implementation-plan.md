...
PDF, DOCX, ODT, HTML, Markdown, YAML, JSON, and signature-checked image formats.
RA-001B-A1 now combines filename/MIME consistency with content signatures,
fatal text decoding and bounded DOCX/ODT ZIP inspection. RA-001B-B adds bounded,
namespace-aware ODT visible-text extraction and advertises it in capabilities;
RTF and legacy DOC extraction remain planned. The result is
